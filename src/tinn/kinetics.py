...
# Soluble salt carriers (E3) deliberately have NO rate law here: they are
# solubility-controlled, so the engine offers the equilibrium whatever the
# water can reach and GEMS decides what stays solid (PRD 4.2 v3.0). Their
# alpha slots stay zero — a fitted time constant would be an invented
# number, and the earlier first-order presets were exactly that.

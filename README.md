...
- [x] **RT-Cl-2 (2026-09-02)** — Cl 표면 수착: 두 번째 사이트 풀 `Surf_c`
...
- [ ] **RT-W5 용출 문헌 앵커 (2026-09-22, 설계·config)** — 기본 P&K 프리셋
      ...
      계산은 다른 컴퓨터(지시서 3차 작업). **실측 ① 32³ 스크리닝(2026-09-23)**: 32 μm 슬랩은
      균일 용출 regime(전선 없음) → CH t_half w/c 비율 Kamali 0.4/0.5 1.44 vs 문헌 1.46 일치;
      Kamali 0.25는 1 μm 해상도 모세관 비퍼콜레이션으로 봉인(RT-02 한계). 64³ 전선 진행 중.
- [x] **review-2026-09 병합 + RT-R06/RT-S1f (2026-09-08)** — 다른 컴퓨터의 dt
      ...
      매 호출 부기 → RT-S1f: 저장소 변화의 산화수 전하 등가로 부기(실측 대기).
      trace-water 반응기 스킵, RT-06 드라이버, 교차 플랫폼 해시 주석 편입.
- [x] **외부 리뷰 대응 (2026-09-07)** — RT-03 반응식 유도 O/H 행, RT-04A/B
      게이트, RT-05 S 단계 재시도, RT-01 적용 플럭스 전하 잔차(+dt 제어 옵션),
      D1 화학 환경 해시, D2 폴백 원소별 크기, RT-02 겔 전용 경로 경고(PRD 참조).
- [x] **RT-W4② 1단계 (2026-09-03)** — 32³ NP 스크리닝: t_half 0.0955 h ≙ 스칼라
      D₀ 0.84e-9(W4.2b 청정 앵커 0.8e-9와 일치). rt-cl 병합(FORMAT 6, E=12), 스위트 298.
- [x] **RT-W4② 2단계 (2026-09-14)** — 64³ NP 전선 완주(v5 resume, 5.3일): **a_NP=332
      μm/√day**(전선 34 vox), 스칼라 0.8e-9 a=251 대비 ~1.32× — 종별 NP가 용출 전선을
      ~30% 빠르게. 재개 지점부터 다른 플랫폼. 기록 PRD RT-W4② 2단계.
...
- [x] **RT-S1e (2026-09-02)** — 외부 황산염 노출 스모크(PRD 4.6.5,
      `sulfate_attack_opc32`, Na2SO4 배스 1.2 h): AFm/hydrogarnet→AFt 즉시,
      CH→석고 선형 전환(0.8 h 소진), 이후 C-S-H 탈칼슘·S 유입 포화(공극
      막힘, 액상 −77%). 정성 순서 재현; 시간축은 RVE 규모(전선 아님), 역학
      비범위, PC 번들 산화환원 미고정(pyrite 미량) 기록.

...
문서 버전: 2.2 / 작성일: 2026-07-14 / 개정: 2026-07-15 (v2.1 SCM, v2.2 전평형 재용해·재료별 입자군·공극 분석), 2026-07-16 (rev.2: 겔 전도 용해 접근 §4.2, 공간 충전 동결 §4.5, 배치 오버플로 §2.2, 기본 번들 CNASH(InverseGems Test) 채택 §1.2/§6.2, 2-스케일 공극 분석 — 네트워크 D_eff·서브복셀 크기분포 §1.3)
